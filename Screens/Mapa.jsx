          ...
          {categorias.map((cat) => {
            ...
            return (
              ...
              >
                ...
                <Text style={[styles.filtroTextoIcon, { fontSize: Math.round(12 * fontScale) }, categoriaId === cat.id && styles.filtroTextoIconAtivo]}>
                  {cat.nome}
                </Text>
              </TouchableOpacity>
            );
      ...
      {selectedPonto && !showDetailModal && (
        <Animated.View style={styles.infoCard}>
          ...
          <Animated.Text
            ...
            style={[styles.title, { fontSize: Math.round(16 * fontScale) }]}
          >
            {selectedPonto.nome}
          </Animated.Text>
          {selectedPonto?.descricao ? (
            <Text numberOfLines={3} ellipsizeMode="tail" style={[styles.desc, { fontSize: Math.round(14 * fontScale) }] }>
              {selectedPonto.descricao}
            </Text>
          ) : null}
        </Animated.View>
